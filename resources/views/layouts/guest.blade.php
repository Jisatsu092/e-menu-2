            ...
            <div class="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-red-600 py-6 px-8 text-white">
                    <div class="flex items-center justify-center mb-4">
                        <div class="bg-red-700 p-1 rounded-full mr-3 h-15 w-15 flex items-center justify-center overflow-hidden">
                            <img src="{{ asset('images/logo.png') }}" class="h-12 w-12 object-cover rounded-full" alt="Logo">
                        </div>
